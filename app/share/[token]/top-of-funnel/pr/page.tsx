      ...
      <div className="min-h-screen bg-page">
        ...
        <main className="max-w-[1160px] mx-auto px-6 py-10">
          ...
          <section className="flex flex-col gap-4">
            <ChartPair
              metric="Mentions"
              monthlyData={toMonthly(prRows, "mentions")}
              quarterlyData={toQ(prRows, "mentions")}
              color={TOF_GREEN}
              fillColor={TOF_FILL}
            />
            <ChartPair
              metric="Earned (%)"
              monthlyData={toMonthly(prRows, "earned_pct")}
              quarterlyData={toQ(prRows, "earned_pct", "avg")}
              color={TOF_GREEN}
              fillColor={TOF_FILL}
            />
            <ChartPair
              metric="SOV (%)"
              monthlyData={toMonthly(prRows, "sov_pct")}
              quarterlyData={toQ(prRows, "sov_pct", "avg")}
              color={TOF_GREEN}
              fillColor={TOF_FILL}
            />
          </section>
