...
export default function TikTokAdsDetailPage() {
  ...
  // ── Chart data ────────────────────────────────────────────────────────────
  const clicksMonthly = toMonthly(tiktokRows, "clicks");
  const clicksQuarterly = toQuarterly(tiktokRows, "clicks", "sum");

  const ctrMonthly = toMonthly(tiktokRows, "ctr_pct");
  const ctrQuarterly = toQuarterly(tiktokRows, "ctr_pct", "avg");

  const cpcMonthly = toMonthly(tiktokRows, "cpc");
  const cpcQuarterly = toQuarterly(tiktokRows, "cpc", "avg");

  const roasMonthly = toMonthly(tiktokRows, "roas");
  const roasQuarterly = toQuarterly(tiktokRows, "roas", "avg");
