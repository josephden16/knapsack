...
export default function MetaAdsDetailPage() {
  ...
  const kpiMetrics: KpiMetric[] = [
    {
      label: "CLICKS",
      value: sumField(metaRows, "clicks"),
      format: "number",
    },
    {
      label: "CTR",
  ...
  // ── Chart data ────────────────────────────────────────────────────────────
  const clicksMonthly = toMonthly(metaRows, "clicks");
  const clicksQuarterly = toQuarterly(metaRows, "clicks", "sum");

  const ctrMonthly = toMonthly(metaRows, "ctr_pct");
  const ctrQuarterly = toQuarterly(metaRows, "ctr_pct", "avg");

  const cpcMonthly = toMonthly(metaRows, "cpc");
  const cpcQuarterly = toQuarterly(metaRows, "cpc", "avg");

  const roasMonthly = toMonthly(metaRows, "roas");
  const roasQuarterly = toQuarterly(metaRows, "roas", "avg");
