...
export default function BrandingAdsDetailPage() {
  ...
  // ── Chart data ────────────────────────────────────────────────────────────
  const impressionsMonthly = toMonthly(brandingRows, "impressions");
  const impressionsQuarterly = toQuarterly(brandingRows, "impressions", "sum");

  const ctrMonthly = toMonthly(brandingRows, "ctr_pct");
  const ctrQuarterly = toQuarterly(brandingRows, "ctr_pct", "avg");

  const roasMonthly = toMonthly(brandingRows, "roas");
  const roasQuarterly = toQuarterly(brandingRows, "roas", "avg");
    ...
    <GranularityProvider>
      <div className="min-h-screen bg-page">
        ...
        <PageHeader
          ...
          subLabel="Middle of Funnel · Branding / Perf. Ads"
          dateRange={dateRange}
